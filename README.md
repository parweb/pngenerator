...
pngenerator : A file preview generator for node.js

Will generate a file preview (gif, jpg or png) of about 450 different document formats.

See pngenerator in action, watch this demo using Angular : https://vimeo.com/151667833

## Installation

pngenerator depends on 'unoconv':

```
  $ apt-get install unoconv
```

pngenerator depends on 'ffmpeg':

```
  $ apt-get install ffmpeg
```

pngenerator depends on 'ImageMagick':

```
  $ apt-get install imagemagick
```

pngenerator depends on 'curl':
...
```javascript
var pngenerator = require('pngenerator');

pngenerator.generate('/home/myfile.docx', '/home/myfile_preview.gif', function (
  error
) {
  if (error) {
...
if (
  !pngenerator.generateSync('/home/myfile.docx', '/home/myfile_preview.gif')
) {
...
You can specify a url instead of a file path, ie: http://www.myfile.com/my_file.doc, and pngenerator will download it to generate its preview.
...
// Asynchronous
pngenerator.generate('/home/myfile.docx', '/home/myfile_preview.gif', options, function(error) {...});

// Synchronous
pngenerator.generateSync('/home/myfile.docx', '/home/myfile_preview.gif', options);
```
...
pngenerator is released under the new BSD license.
